...
<?php
  ...
  if(mysqli_num_rows($result)>0){
    ...
    echo'<table class="w3-table w3-striped w3-border" style="width:100%"><tr><th>Depart</th><th>Warehouse</th><th>Destination</th></tr>';
      // output data of each row
      while($row = mysqli_fetch_assoc($result)){

          echo'<tr><td>'.$row["Depart"].'</td><td>'.$row["Warehouse_Location"].'</td><td>'.$row["Destination"].'</td></tr>';}
      echo'</table>';
